    ...
    <div class="col-md-6">
      <div class="form-group">
          ...
          <div class="col-sm-9">
              ...
              <input value="<?php echo e(isset($oldvalues) ? $oldvalues[$index] : ''); ?>" type="text" class="form-control" name="<?=$stringformat?>" id="input<?=$stringformat?>" placeholder="<?php echo e($attr); ?>">
